 ...
 * FragmentManager `isStateSaved()`, so no callback ever fires and the caller would suspend forever
 * holding the process-wide prompt gate. Needs no enrolled biometric and shows no UI.
 */
