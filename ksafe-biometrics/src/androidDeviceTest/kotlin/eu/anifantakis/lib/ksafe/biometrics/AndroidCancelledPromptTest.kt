 ...
 * never reaches `BiometricPrompt.authenticate`, so the system sheet cannot appear over the screen
 * the user moved on to. The show seam stands in for the sheet — it counts the attempt and throws,
 * so no real prompt is ever raised and no enrolled biometric is needed.
 */
