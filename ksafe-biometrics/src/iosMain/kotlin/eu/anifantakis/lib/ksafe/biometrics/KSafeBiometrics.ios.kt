...
/**
 * iOS implementation of [KSafeBiometrics].
 *
 * Uses `LAContext.evaluatePolicy(LAPolicyDeviceOwnerAuthenticationWithBiometrics, …)`.
 * Returns `true` on the simulator (no biometric hardware available).
 */
@Suppress("unused")
