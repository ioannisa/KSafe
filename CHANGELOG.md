...
Android performance + numeric type-coercion release. **Drop-in upgrade from 2.1.1** — on-disk format is unchanged and existing data keeps working without migration.
