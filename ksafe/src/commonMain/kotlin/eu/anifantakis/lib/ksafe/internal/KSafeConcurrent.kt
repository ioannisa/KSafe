...
/** Blocks the caller until this job completes or [timeoutMs] passes; false on timeout. */
internal fun Job.joinBlockingWithin(timeoutMs: Long): Boolean =
    runBlockingOnPlatform { withTimeoutOrNull(timeoutMs) { join() } != null }
