...
data class KSafeProtectionInfo(
     ...
     * `jvm_user_opted_out`, `android_strongbox_absent`, `android_lock_screen_absent`,
     * `apple_secure_enclave_absent`, `apple_keychain_entitlement_missing` and
     * `relaxed_default_uses_software_dek` are weaker than intended but still operational.
     */
