...
/**
 * Protection tier and key custody of one stored key, as returned by [KSafe.getKeyInfo].
 *
 ...
 * @property keyGeneration Key generation that decrypts this entry: 1 until [KSafe.rotateKeys]
 *   moves it, always 1 for plaintext entries.
 */
