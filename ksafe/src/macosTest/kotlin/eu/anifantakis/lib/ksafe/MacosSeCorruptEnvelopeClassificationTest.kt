...
class MacosSeCorruptEnvelopeClassificationTest {
    ...
    /**
     * The outer SE catch recognises a propagated unwrap failure by substring; lose the marker and
     * the failure reads as "SE unavailable" and the alias silently downgrades to a plain key.
     */
    @Test
