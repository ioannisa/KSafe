 ...
 * @param securityPolicy Accepted for API parity but inert on web: a browser exposes no root,
 *   debugger, debug-build or emulator signal, so no violation is ever detected and no `BLOCK`
 *   can throw.
